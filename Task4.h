    ...
    private: bool ValidInside(String^ a, Windows::Forms::RichTextBox^ txtIn4) {
        ...
        if (a[0] == '+' || a[0] == '*' || a[0] == '/') {
            ...
            for (int i = 0; (i < a->Length); i++) {
                ...
                //если со скобкой нет нужного знака или если два нул€ (в старших разр€дах)
                else {
                    if (a[i-1] == ')') {
                        txtIn4->Select(i, 1);
                        txtIn4->SelectionColor = Color::Red;
